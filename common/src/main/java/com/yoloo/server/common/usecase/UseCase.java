 ...
 *
 * <p>Use case will have only one method - {@link #execute(Request, Response)}. This method takes a
 ...
 *
 * <p>Usually response object is being implemented by {@link
 * pl.gov.coi.cleanarchitecture.presentation.Presenter} object.
 *
 */
@FunctionalInterface
