 ...
 */
public interface EntityManager<E> extends ObjectifyAware {
  /**
   ...
   */
  @Nonnull
  default <I> List<I> getId(Collection<E> entities) {
  ...
  @Nonnull
  @SuppressWarnings("unchecked")
  default <I> List<I> getId(E... entities) {
