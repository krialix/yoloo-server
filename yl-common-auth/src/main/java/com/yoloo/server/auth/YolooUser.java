...
public class YolooUser implements UserDetails {

  private final FirebaseToken token;
  private final List<GrantedAuthority> authorities;

  private YolooUser(FirebaseToken token) {
    this.token = token;
  ...
  public static YolooUser fromToken(FirebaseToken token) {
    return new YolooUser(token);
  }
