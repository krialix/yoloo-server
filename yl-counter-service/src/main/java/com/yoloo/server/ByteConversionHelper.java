...
/**
 * ByteConversionHelper to help in transforming long values to platform-specific byte arrays and
 * back again.
 */
final class ByteConversionHelper {
  ...
  public static byte[] longToByte(long value) {
    ByteBuffer longBuffer = ByteBuffer.allocate(8).order(ByteOrder.nativeOrder());
    longBuffer.clear();
  ...
  /**
   * Transforms platform specific byte representation to long value.
   *
